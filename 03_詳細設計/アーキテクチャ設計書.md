# アーキテクチャ設計書 — テーマ別最新情報アグリゲーター（詳細設計）

| 項目 | 内容 |
|---|---|
| 版 | 1.0（詳細設計・初版） |
| 作成日 | 2026-08-08 |
| 前工程 | `02_基本設計/` 一式（承認済み）／[`01_要件定義/要件定義書.md`](../01_要件定義/要件定義書.md) §4 技術構成 |
...
| **infrastructure**（DD-ARC-02） | ポートの**実装**：Spring Data JPA リポジトリ、`RestClient` クライアント（Claude/LINE/HTTP取得）、ROME/jsoup アダプタ、robots(crawler-commons)、`AttributeConverter` | domain | FR-02/03・§6 |
| **web**（DD-ARC-03） | Vaadin Flow の画面（SC-01〜10）、Spring Security、表示用DTOとJST変換 | domain・infrastructure | SC-* |
...
| RSS/HTML/robots | ROME / jsoup / crawler-commons | infrastructure アダプタ |
